# GarrysCraft (Previously known as mcgm)
...
- Minecraft Java 1.12.2 offline mode and online mode support. (if somone wants to try to get 1.13 working please make a PR although it must also still support 1.12)
